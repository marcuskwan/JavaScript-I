...
// created carModels, assigned to empty array
let carModels = [];
// creating for loop that loops the array and pushes each object's car model to carModels
for (let i = 0; i < inventory.length; i++) {
    carModels.push(inventory[i]['car_model']);
}
// sorting carModels array alphabetically
carModels.sort();
// logging carModels
...
// created carYears, assigned to empty array
let carYears = [];
// created for loop that loops throughout array and pushes each object's car year to carYears
for (let i = 0; i < inventory.length; i++) {
...
// created oldCars, assigned to empty array
let oldCars = [];
// creating for loop that loops throughout array and pushes the ID of the cars whose years are older than year 2000
for (let i = 0; i < inventory.length; i++) {
...
// created BMWAndAudi, assigned to empty array
let BMWAndAudi = [];
// creating for loop that loops throughout inventory array and pushes the models of BMW and Audi cars to BMWAndAudi array.
for (let i = 0; i < inventory.length; i++) {
